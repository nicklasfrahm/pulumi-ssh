PROJECT_NAME := Pulumi SSH Resource Provider

PACK             := ssh
PACKDIR          := sdk
PROJECT          := github.com/pulumi/pulumi-ssh
NODE_MODULE_NAME := @pulumi/ssh
NUGET_PKG_NAME   := Pulumi.SSH
...
SCHEMA_FILE     := provider/cmd/pulumi-resource-ssh/schema.json
